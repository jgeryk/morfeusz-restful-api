...
class StringsSet(_object):
    ...
    def add(self, *args): return _morfeusz2.StringsSet_add(self, *args)
    def discard(self, *args): return _morfeusz2.StringsSet_discard(self, *args)
    def __init__(self, *args): 
...
class _Morfeusz(_object):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_getmethods__["getVersion"] = lambda x: _morfeusz2._Morfeusz_getVersion
    if _newclass:getVersion = staticmethod(_morfeusz2._Morfeusz_getVersion)
    __swig_getmethods__["getDefaultDictName"] = lambda x: _morfeusz2._Morfeusz_getDefaultDictName
    if _newclass:getDefaultDictName = staticmethod(_morfeusz2._Morfeusz_getDefaultDictName)
    __swig_getmethods__["getCopyright"] = lambda x: _morfeusz2._Morfeusz_getCopyright
    if _newclass:getCopyright = staticmethod(_morfeusz2._Morfeusz_getCopyright)
    __swig_getmethods__["createInstance"] = lambda x: _morfeusz2._Morfeusz_createInstance
    if _newclass:createInstance = staticmethod(_morfeusz2._Morfeusz_createInstance)
    def getDictID(self): return _morfeusz2._Morfeusz_getDictID(self)
    def getDictCopyright(self): return _morfeusz2._Morfeusz_getDictCopyright(self)
    def clone(self): return _morfeusz2._Morfeusz_clone(self)
    ...
    def analyse(self, text):
        ...
        """
        res = InterpsList()
        _morfeusz2._Morfeusz_analyse(self, text.encode('utf-8'), res)
        return res
    ...
    def setAggl(self, optionString):
        ...
        """
        _morfeusz2._Morfeusz_setAggl(self, optionString.encode('utf8'))


    def getAggl(self): return _morfeusz2._Morfeusz_getAggl(self)
    def setPraet(self, optionString):
        """
        Select past tense segmentation
        """
        _morfeusz2._Morfeusz_setPraet(self, optionString.encode('utf8'))


    def getPraet(self): return _morfeusz2._Morfeusz_getPraet(self)
    ...
    def getCaseHandling(self): return _morfeusz2._Morfeusz_getCaseHandling(self)
    ...
    def getTokenNumbering(self): return _morfeusz2._Morfeusz_getTokenNumbering(self)
    ...
    def getWhitespaceHandling(self): return _morfeusz2._Morfeusz_getWhitespaceHandling(self)
    def getIdResolver(self): return _morfeusz2._Morfeusz_getIdResolver(self)
    def setDictionary(self, dictName):
        """
        Set dictionary to be used by this instance (by name)
        """
        _morfeusz2._Morfeusz_setDictionary(self, dictName.encode('utf8'))
    ...
    if _newclass:dictionarySearchPaths = _swig_property(_morfeusz2._Morfeusz_dictionarySearchPaths_get, _morfeusz2._Morfeusz_dictionarySearchPaths_set)
    def getAvailableAgglOptions(self): return _morfeusz2._Morfeusz_getAvailableAgglOptions(self)
    def getAvailablePraetOptions(self): return _morfeusz2._Morfeusz_getAvailablePraetOptions(self)
    def _generateByTagId(self, *args): return _morfeusz2._Morfeusz__generateByTagId(self, *args)
    def analyse_iter(self, text):
        """
        Analyse given text and return an iterator over MorphInterpretation objects as a result.
        """
        return _morfeusz2._Morfeusz__analyseAsIterator(self, text.encode('utf-8'))


_Morfeusz_swigregister = _morfeusz2._Morfeusz_swigregister
_Morfeusz_swigregister(_Morfeusz)

def _Morfeusz_getVersion():
  return _morfeusz2._Morfeusz_getVersion()
_Morfeusz_getVersion = _morfeusz2._Morfeusz_getVersion

def _Morfeusz_getDefaultDictName():
  return _morfeusz2._Morfeusz_getDefaultDictName()
_Morfeusz_getDefaultDictName = _morfeusz2._Morfeusz_getDefaultDictName

def _Morfeusz_getCopyright():
  return _morfeusz2._Morfeusz_getCopyright()
_Morfeusz_getCopyright = _morfeusz2._Morfeusz_getCopyright

def _Morfeusz_createInstance(*args):
...
class MorphInterpretation(_object):
    ...
    def getName(self, morfeusz):
        ...
        """
        name = _morfeusz2.MorphInterpretation_getName(self, morfeusz).decode('utf8')
